...
| 9 | **Osc3 audio-rate footage pitch** | 1.1 | ⏸ PARKED — runtime dump blocked (2026-07-14) | uncommon | shares #8's un-dumpable object; 2 static hypotheses remain. Clone uses `2^((b−144)/48)`. **Close via audio-render extraction** (render osc3 per footage, measure pitch). |
