...
VAZPhaserAudioProcessorEditor::VAZPhaserAudioProcessorEditor (VAZPhaserAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    stagesAtt    = attach (ParameterIDs::stages,    stagesRelay);
    frequencyAtt = attach (ParameterIDs::frequency, frequencyRelay);
...
void VAZPhaserAudioProcessorEditor::paint (juce::Graphics& g) { g.fillAll (juce::Colour (0xff2a0d0d)); }
...
VAZPhaserAudioProcessorEditor::getResource (const juce::String& url)
{
