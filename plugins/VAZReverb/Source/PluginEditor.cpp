...
VAZReverbAudioProcessorEditor::VAZReverbAudioProcessorEditor (VAZReverbAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    reverbTimeAtt = attach (ParameterIDs::reverb_time, reverbTimeRelay);
    toneAtt       = attach (ParameterIDs::tone,        toneRelay);
...
VAZReverbAudioProcessorEditor::~VAZReverbAudioProcessorEditor() {}

void VAZReverbAudioProcessorEditor::paint (juce::Graphics& g) { g.fillAll (juce::Colour (0xff2a0d0d)); }
...
VAZReverbAudioProcessorEditor::getResource (const juce::String& url)
{
